      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://localhost:8501/api/v1/users/signup',
              data: {
                name: name,
                email: email,
                password: password,
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFuaXNoYm9ybyIsImEiOiJjazcwczFwdjMwMGJrM2xtdDA2aGtjano0In0.DEWb2BKOGNz19usGXDSC6Q';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:8501/api/v1/users/updateMyPassword' : 'http://localhost:8501/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 8:
            ...
            // }
            (0, _alerts.showAlert)('error', _context.t0.response.data.message.split(':')[2]);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            // console.log(res);
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Please check your email for the reset link!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(password, passwordConfirm, params) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:8501/api/v1/users".concat(params),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
...
var stripe = Stripe('pk_test_LdX6Vepk9OUMfGd5dX4BlA3C00JLVPYYo5');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:8501/api/v1/bookings/checkout-session/".concat(tourId));
...
var bookBtn = document.getElementById('book-tour-0');
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              //'updateSettings' function returns a promise
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email-forgotPassword').value;
