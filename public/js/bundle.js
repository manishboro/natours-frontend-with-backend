        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              email = document.getElementById('email-forgotPassword').value;
              _context3.next = 5;
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var params, password, passwordConfirm;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              password = document.getElementById('password-resetPassword').value;
              passwordConfirm = document.getElementById('passwordConfirm-resetPassword').value;
              _context4.next = 7;
              return (0, _forgotPassword.resetPassword)(password, passwordConfirm, params);
